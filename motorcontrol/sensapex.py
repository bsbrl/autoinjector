...
class UMP(object):
    ...
    def get_axis_angle(self, dev, axis, layer):
        axis_angle = self.call('ump_cmd_get_axis_angle',
                               c_int(dev), c_int(axis), c_int(layer))
        return axis_angle
...
class SensapexDevice(object):
    ...
    def get_axis_angle(self, axis, layer):
        ''' Created by Jacob to get angle of D axis'''
        return self.ump.get_axis_angle(self.devid, axis, layer)
